...
public class Tests {
    public static void callTestsForInMemoryManagers() {
        // Tests for Sprint 3
        {
            ...
            kanban.createTask("Сделать домашку по ивриту", "См. стр. 33 учебника",
                    TaskStatus.NEW);
            ...
            kanban.createEpicTask("Сдать финальное задание Практикума", "Проект канбана",
                    TaskStatus.NEW);
            kanban.createEpicTask("Подтвердить диплом",
            ...
            kanban.createSubTask("Проверить код стайл", "См. правила код стайла", TaskStatus.NEW,
                    3);
            kanban.createSubTask("Получить подтверждение в министерстве абсорбции",
    ...
    public static void callTestForFiledBackedManagerWrite (){
        //TaskManager is instantiated with empty file
        {
            ...
            kanbanBacked.createTask("Сделать домашку по ивриту", "См. стр. 33 учебника",
                    TaskStatus.NEW);
            ...
            kanbanBacked.createEpicTask("Подтвердить диплом",
                    "Подтверждение диплома в министерстве образования", TaskStatus.NEW);
            kanbanBacked.createSubTask("Подготовить код", "См. ТЗ 3го спринта", TaskStatus.NEW,
                    3);
    ...
    public static void callTestForFiledBackedManagerRead() {
